#
#  Be sure to run `pod spec lint aquasync.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Aquamarine"
  # s.authors            = { "Aquamarine" => "" }
  # s.social_media_url   = "http://twitter.com/Aquamarine"
